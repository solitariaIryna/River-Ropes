...
Shader "Radiation2"
{
	...
	SubShader
	{
		...
		void vertex_surface(inout appdata_tcp2 v, out Input output)
		{
			...
			float __wavesHeight = ( _WavesHeight * worldPosUv.y );
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			float __foamStrength = ( _FoamStrength * input.worldPos.y );
